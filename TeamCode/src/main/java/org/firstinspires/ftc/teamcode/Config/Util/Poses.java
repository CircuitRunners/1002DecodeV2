...
public class Poses {
    ...
    public static double RED_GOAL_X = 143.5;
    public static double BLUE_GOAL_X = 5;
    public static double GOAL_Y = 124;
...
//        telemetry.update();
  ...
  /*EXAMPLE*/  private static final AlliancePose preloadPose = new AlliancePose(
    ...
    public static final AlliancePose getMotif = new AlliancePose(
            new Pose(90, 95.5, Math.toRadians(180)),      // Red: X=144-32=112, Theta=180-180=0
            new Pose(54, 95.5, Math.toRadians(0))        // Blue
    );
...
//    );
    ...
    public static final AlliancePose shootPositionGoalSide15BallTangent = new AlliancePose(
            ...
            new Pose(51.5, 84, Math.toRadians((321.5 + 180)) % 360) // 144 - 100.5 = 43.5
    );
    ...
    public static final AlliancePose shootPositionGoalSide15BallTangentLastTime = new AlliancePose(
            ...
            new Pose(47.5, 106, Math.toRadians(270)) // 144 - 100.5 = 43.5
    );
...
//    );
    ...
    public static final AlliancePose pickupLineOne15Ball = new AlliancePose(
            new Pose(138, 74, Math.toRadians(0)),
    ...
    public static final AlliancePose pickupLine2 = new AlliancePose(
            new Pose(146, 51, Math.toRadians(0)),
            new Pose(20, 57, Math.toRadians(180))
    );
    ...
    public static final AlliancePose line2ControlPoint = new AlliancePose(
            new Pose(90, 55.5, Math.toRadians(0)),
...
//    );
    ...
    public static final AlliancePose openGateHighCycle = new AlliancePose(
            new Pose(151.5, 58.5, Math.toRadians(45)),
            new Pose(20, 61.5, Math.toRadians(135)) // correct
    );
    public static final AlliancePose openGateHighCycleBackupPoint = new AlliancePose(
            new Pose(151.5, 58.5, Math.toRadians(45)),
            new Pose(26.5, 61.5, Math.toRadians(135)) // correct
    );
    public static final AlliancePose openGateHighCycleTangent = new AlliancePose(
            new Pose(146, 65, Math.toRadians(0)),
            new Pose(25.5, 68, Math.toRadians(180)) // correct
    );
    public static final AlliancePose openGateHighCycleTangentBackUp = new AlliancePose(
            new Pose(143, 65, Math.toRadians(0)),
            new Pose(28.5, 68, Math.toRadians(180)) // correct
    );
    ...
    public static final AlliancePose startPose18Ball = new AlliancePose(
            ...
            new Pose(25.9, 109.4, Math.toRadians((321.5 + 180)) % 360)
    );
    public static final AlliancePose shootPositionFarSide = new AlliancePose(
            new Pose(90, 11.5, Math.toRadians(0)),
            new Pose(54, 11.5, Math.toRadians(180))
    );
