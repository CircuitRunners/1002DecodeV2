...
//                (v_c * Math.pow(x, 2)) + (v_d * x) + v_e;
    ...
    public double getCurrentTurretPosition(){
        double turret1CurrentTurretPosition = Range.scale(turret1.getPosition(), turret1MinRange, turret1MaxRange, -180, 180);
        double turret2CurrentTurretPosition = Range.scale(turret2.getPosition(), turret2MinRange, turret2MaxRange, -180, 180);
        return (turret1CurrentTurretPosition + turret2CurrentTurretPosition) / 2;
    }
    ...
    public void updateTurretPosition(double currentAngle) {
        ...
        else if (targetTurretPosition == 0 && ((targetTurretPosition - currentAngle) <= 2)){ //tolerance
            return;
        }
        else {
