...
//    public static double slotTwoBLueAtan = 0;
        ...
        public OldShooter(HardwareMap hardwareMap, Telemetry telemetry) {
...
//    }
        ...
        public void setTurretTarget(double inputFieldDeg, org.firstinspires.ftc.teamcode.Config.Subsystems.Shooter.TurretMode mode, double robotFieldYawDeg) {
...
//        }
         ...
         */
        private org.firstinspires.ftc.teamcode.Config.Subsystems.OldShooter.OptimalShot calculateOptimalShot(double robotXInches, double robotYInches,
                                                                                                          double targetXInches, double targetYInches) {
            ...
            if (R < 0.1) {
                return new org.firstinspires.ftc.teamcode.Config.Subsystems.OldShooter.OptimalShot(0.0, 90.0, 0.0);
            }
            ...
            if (searchMinAngle >= searchMaxAngle) {
                ...
                return new org.firstinspires.ftc.teamcode.Config.Subsystems.OldShooter.OptimalShot(0.0, 0.0, -1.0);
            }
            ...
            return new org.firstinspires.ftc.teamcode.Config.Subsystems.OldShooter.OptimalShot(optimalVeloTicks, optimalAngleDeg, bestTimeOfFlight);
        }
...
//        return t_short;
                ...
                double targetXInches, double targetYInches, double robotXVelo, double robotYVelo)
        {
            ...
            org.firstinspires.ftc.teamcode.Config.Subsystems.OldShooter.OptimalShot shot = calculateOptimalShot(
            ...
            org.firstinspires.ftc.teamcode.Config.Subsystems.OldShooter.OptimalShot newShot = calculateOptimalShot(
                    robotXInches, robotYInches,
                    targetXInches, targetYInches);
...
//    }
        ...
        public void setTargetsByDistance(double robotX, double robotY, double goalX, double goalY, double robotAngle, boolean autoAlign, double hoodMannualAdjustment, boolean isRed) {
            ...
            if (autoAlign){
                ...
                // B. Pass to the turret setter
                setTurretTarget(requiredFieldYaw, org.firstinspires.ftc.teamcode.Config.Subsystems.Shooter.TurretMode.AUTO_ALIGN, robotAngle);
            }
        }

        public void setTargetsByDistanceAuto(double robotX, double robotY, double goalX, double goalY, double robotAngle, boolean autoAlign, double hoodMannualAdjustment, boolean isRed) {
            double x = Math.hypot(goalX - robotX, goalY - robotY); // distance
            ...
            setTargetVelocityTicks(velo + 4000);
            setHoodTargetAngle(Range.clip(hoodPos + hoodMannualAdjustment,0,45));
            if (autoAlign){
                double requiredFieldYaw;
                if (!isRed) {
