...
@Configurable
@Autonomous(name = "2x open gate close 12 ball NEW", group = "A", preselectTeleOp = "v2Teleop")

public class TwelveBall2xOpenGate extends OpMode {
    ...
    public void autonomousPathUpdate() {
        ...
        switch (pathState) {
            ...
            case 200:
                ...
                if (!follower.isBusy()) {
                    intake.doIntakeHalt();
                    follower.followPath(openGateLine2, false);
                    setPathState();
                }
                break;
            ...
            case 6: // WAIT at Gate (Cycle 1)
                ...
                if ((!follower.isBusy())) {
                    follower.followPath(openGateLine1);
                    setPathState();
                }
                break;
